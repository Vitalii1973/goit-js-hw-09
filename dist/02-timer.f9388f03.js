...
var _notiflix = require("notiflix"); // Используем * as Notiflix, чтобы импортировать всё из Notiflix
...
function updateTimer() {
    ...
    if (endDate <= currentDate) {
        ...
        timerId = null;
        _notiflix.Notify.success("Time is up!"); // Используем Notiflix.Notify.success
        return;
    }
...
// Настройка flatpickr
const flatpickrInstance = (0, _flatpickrDefault.default)(dateTimePicker, {
    enableTime: true,
    time_24hr: true,
